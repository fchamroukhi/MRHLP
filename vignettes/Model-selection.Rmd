...
In this package, it is possible to select models based on criteria such as 
**BIC** and **AIC**.
...
x <- simulatedtimeseries$X
y <- simulatedtimeseries[, 2:ncol(simulatedtimeseries)]
...
```{r}
selectedmrhlp$plot(what = "meancurve")
```
